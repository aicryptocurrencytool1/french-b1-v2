    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-amber-50 p-6 md:p-8 rounded-2xl border-2 border-dashed border-amber-200">
                 ...
                 <ul className="list-disc list-outside space-y-2 ps-6 text-amber-900">
                    <li><span className="font-semibold">Passé composé :</span> actions ponctuelles terminées.</li>
                    <li><span className="font-semibold">Imparfait :</span> descriptions, habitudes, durées.</li>
                    <li><span className="font-semibold">Plus-que-parfait :</span> action passée avant une autre action passée.</li>
                    <li><span className="font-semibold">Conditionnel :</span> conseils (tu devrais), souhaits (j’aimerais), politesse (je voudrais).</li>
                    <li><span className="font-semibold">Futur :</span> futur proche (certain) et futur simple (moins certain).</li>
                    <li><span className="font-semibold">Vocabulaire :</span> logement, quartier, personnalité, faits divers.</li>
                 </ul>
            </div>
        </div>
    );
